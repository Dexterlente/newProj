...
from . import views
from dj_rest_auth.views import LoginView, PasswordResetView, PasswordResetConfirmView, UserDetailsView, PasswordChangeView
...
urlpatterns = [
    ...
    path("dj-rest-auth/registration/",
         views.RegisterAPIView.as_view(), name="account_signup"),
    path('dj-rest-auth/registration/', include('dj_rest_auth.registration.urls')),
    # verify
    path("dj-rest-auth/registration/verify-email/",
         VerifyEmailView.as_view(), name='account_email_verification_sent'),
    path("dj-rest-auth/registration/resend-email/", ResendEmailVerificationView.as_view(),
         name='account_resend_email_verification_sent'),
    ...
    # reset pass
    re_path(r'^dj-rest-auth/password/reset/$',
